      ...
      >
        ...
        <div className="space-y-6">
          <p className="text-sm font-medium text-black">
            Do you really want to remove this issue? This action cannot be
            undone.
          </p>
          ...
          <div className="flex gap-3">
            <button
              ...
              className="px-4 py-2 bg-destructive cursor-pointer button-redborder w-30 text-white text-sm font-semibold rounded-md "
            >
              Remove
            </button>
            <button
              onClick={() => onOpenChange(false)}
              className="px-4 py-2 border cursor-pointer border-gray-300 hover:bg-gray-50 w-30 text-sm font-semibold rounded-md"
            >
              Cancel
            </button>
          </div>
